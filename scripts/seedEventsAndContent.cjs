...
const CHICAGO_EVENTS = [
  // January
  {
    ...
    description: 'Sample Chicago\'s finest cuisine with special prix-fixe menus at top restaurants throughout the city.',
    ...
    transportationTips: 'Book a luxury sedan for a memorable dining experience. Our chauffeurs know the best routes to avoid downtown traffic.',
    recommendedServices: ['airport-dining', 'corporate-dinner', 'point-to-point'],
    recommendedVehicles: ['sedan', 'luxury-sedan', 'suv'],
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/royalcarriagelimoseo.firebasestorage.app/o/events%2Frestaurant-week.jpg?alt=media',
    featured: true
  },
  {
    ...
    description: 'The largest auto show in North America featuring the latest vehicles from top manufacturers.',
    ...
    transportationTips: 'Avoid parking hassles at McCormick Place. Our drivers drop you at the entrance and pick you up when you\'re ready.',
    recommendedServices: ['point-to-point', 'hourly-charter', 'corporate-event'],
    recommendedVehicles: ['sedan', 'suv', 'van'],
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/royalcarriagelimoseo.firebasestorage.app/o/events%2Fauto-show.jpg?alt=media',
    featured: true
  },
  // February
  {
    ...
    description: 'Enjoy discounted tickets to over 100 productions at theaters throughout Chicago.',
    ...
    transportationTips: 'Arrive in style for your theater night. We\'ll drop you at the door and wait nearby for your show to end.',
    recommendedServices: ['point-to-point', 'hourly-charter'],
    recommendedVehicles: ['sedan', 'luxury-sedan'],
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/royalcarriagelimoseo.firebasestorage.app/o/events%2Ftheater-week.jpg?alt=media',
    featured: false
  },
  // March
  {
    ...
    description: 'Watch the Chicago River turn green and enjoy the famous downtown parade celebrating Irish heritage.',
    ...
    transportationTips: 'Downtown parking is impossible during St. Patrick\'s Day. Let us handle transportation so your group can celebrate safely.',
    recommendedServices: ['party-bus', 'group-transportation'],
    recommendedVehicles: ['partyBus', 'van', 'suv'],
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/royalcarriagelimoseo.firebasestorage.app/o/events%2Fst-patricks.jpg?alt=media',
    featured: true
  },
  // April
  {
    ...
    description: 'Kick off baseball season at historic Wrigley Field with the Chicago Cubs.',
    ...
    transportationTips: 'Skip the Wrigleyville parking nightmare. We drop you steps from Wrigley and pick you up after the last pitch.',
    recommendedServices: ['point-to-point', 'party-bus', 'group-transportation'],
    recommendedVehicles: ['suv', 'van', 'partyBus'],
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/royalcarriagelimoseo.firebasestorage.app/o/events%2Fcubs-game.jpg?alt=media',
    featured: true
  },
  // May
  {
    ...
    description: 'Kick off summer in the heart of historic Lincoln Park with live music, drinks, art shows, and local vendors.',
    ...
    category: 'festival',
    venues: ['Lincoln Park'],
    transportationTips: 'Enjoy the festival without worrying about parking. Our drivers know the best drop-off points near the action.',
    recommendedServices: ['point-to-point', 'group-transportation'],
    recommendedVehicles: ['suv', 'van'],
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/royalcarriagelimoseo.firebasestorage.app/o/events%2Fmayfest.jpg?alt=media',
    featured: false
  },
  {
    ...
    description: 'Sample delicious fare from the best food trucks in the Chicago area at this Naperville celebration.',
    ...
    transportationTips: 'Coming from O\'Hare or Midway? Book our Naperville airport transfer and arrive stress-free.',
    recommendedServices: ['airport-transfer', 'point-to-point'],
    recommendedVehicles: ['sedan', 'suv'],
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/royalcarriagelimoseo.firebasestorage.app/o/events%2Ffood-truck.jpg?alt=media',
    featured: false
  },
  // June
  {
    ...
    description: 'Experience award-winning BBQ, live music, and family fun at the 33rd annual Ribfest over Father\'s Day weekend.',
    location: 'Naperville',
    locationSlug: 'naperville',
    ...
    transportationTips: 'Bring the whole family! Our SUVs and vans are perfect for groups heading to Ribfest from anywhere in Chicagoland.',
    recommendedServices: ['group-transportation', 'point-to-point', 'airport-transfer'],
    recommendedVehicles: ['suv', 'van', 'luxury-suv'],
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/royalcarriagelimoseo.firebasestorage.app/o/events%2Fribfest.jpg?alt=media',
    featured: true
  },
  {
    ...
    slug: 'chicago-pride',
    description: 'Celebrate Pride in the country\'s oldest official gay neighborhood with one of the largest Pride celebrations in the world.',
    ...
    transportationTips: 'Book a party bus for your Pride celebration! Our buses are perfect for groups wanting to bar hop and celebrate safely.',
    recommendedServices: ['party-bus', 'group-transportation', 'bar-crawl'],
    recommendedVehicles: ['partyBus', 'van', 'stretch-limo'],
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/royalcarriagelimoseo.firebasestorage.app/o/events%2Fpride-fest.jpg?alt=media',
    featured: true
  },
  {
    ...
    description: 'Ed Sheeran brings The Loop Tour to Soldier Field for an unforgettable concert experience.',
    ...
    transportationTips: 'Skip the post-concert traffic nightmare. Our driver waits nearby and picks you up right after the show.',
    recommendedServices: ['point-to-point', 'hourly-charter', 'group-transportation'],
    recommendedVehicles: ['suv', 'van', 'partyBus'],
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/royalcarriagelimoseo.firebasestorage.app/o/events%2Fconcert.jpg?alt=media',
    featured: true
  },
  // Naperville Events
  {
    ...
    description: 'Four-day family-friendly community event over Labor Day weekend featuring carnival, national artists, beer gardens, and Illinois\' largest Labor Day parade.',
    location: 'Downtown Naperville',
    locationSlug: 'naperville',
    ...
    category: 'festival',
    venues: ['Downtown Naperville'],
    transportationTips: 'Hosting out-of-town guests for Labor Day? Book airport transfers from O\'Hare to Naperville with ease.',
    recommendedServices: ['airport-transfer', 'group-transportation', 'point-to-point'],
    recommendedVehicles: ['sedan', 'suv', 'van'],
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/royalcarriagelimoseo.firebasestorage.app/o/events%2Flast-fling.jpg?alt=media',
    featured: true
  }
];
...
const CITY_CONTENT = {
  naperville: {
    ...
    description: 'Naperville is one of Chicago\'s most vibrant suburbs, known for its beautiful Riverwalk, thriving downtown, excellent schools, and year-round festivals. From Ribfest to Last Fling, Naperville hosts some of the region\'s best events.',
    whyLimoService: [
    ...
    popularRoutes: [
      { from: 'Naperville', to: 'O\'Hare Airport', time: '35-50 min', distance: '30 miles' },
      { from: 'Naperville', to: 'Midway Airport', time: '30-40 min', distance: '25 miles' },
      { from: 'Naperville', to: 'Downtown Chicago', time: '40-55 min', distance: '32 miles' },
      { from: 'Naperville', to: 'McCormick Place', time: '35-50 min', distance: '30 miles' }
    ],
    landmarks: ['Naperville Riverwalk', 'Centennial Beach', 'Naper Settlement', 'Downtown Naperville', 'DuPage Children\'s Museum'],
    nearbyVenues: ['Hotel Arista', 'Westin Chicago Lombard', 'Meson Sabika', 'Maggiano\'s', 'Sullivan\'s Steakhouse']
  },
  schaumburg: {
    name: 'Schaumburg',
    slug: 'schaumburg',
    tagline: 'Shopping, Dining & Entertainment Hub',
    description: 'Schaumburg is home to Woodfield Mall, one of the largest shopping centers in the US, plus a thriving restaurant scene and the Schaumburg Boomers baseball team.',
    whyLimoService: [
    ...
    popularRoutes: [
      { from: 'Schaumburg', to: 'O\'Hare Airport', time: '15-25 min', distance: '8 miles' },
      { from: 'Schaumburg', to: 'Downtown Chicago', time: '35-50 min', distance: '28 miles' },
      { from: 'Schaumburg', to: 'Midway Airport', time: '40-55 min', distance: '30 miles' }
    ],
    landmarks: ['Woodfield Mall', 'Wintrust Field', 'Legoland Discovery Center', 'Medieval Times', 'Streets of Woodfield'],
    nearbyVenues: ['Renaissance Schaumburg', 'Hyatt Regency Schaumburg', 'Capital Grille', 'Weber Grill']
  },
  evanston: {
    name: 'Evanston',
    slug: 'evanston',
    tagline: 'Where Culture Meets Lake Michigan',
    description: 'Evanston is home to Northwestern University, beautiful lakefront parks, and a vibrant downtown with diverse dining and shopping options.',
    whyLimoService: [
    ...
    popularRoutes: [
      { from: 'Evanston', to: 'O\'Hare Airport', time: '25-40 min', distance: '18 miles' },
      { from: 'Evanston', to: 'Downtown Chicago', time: '20-35 min', distance: '12 miles' },
      { from: 'Evanston', to: 'Midway Airport', time: '35-50 min', distance: '22 miles' }
    ],
    landmarks: ['Northwestern University', 'Baha\'i Temple', 'Lighthouse Beach', 'Downtown Evanston', 'Grosse Point Lighthouse'],
    nearbyVenues: ['Hilton Orrington/Evanston', 'Hotel Orrington', 'Found Kitchen', 'Oceanique']
  }
};
...
const BLOG_POSTS = [
  {
    ...
    excerpt: 'From Ribfest to O\'Hare transfers, discover why Naperville is one of our most popular service areas.',
    content: `
    ...
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/royalcarriagelimoseo.firebasestorage.app/o/blog%2Fnaperville-riverwalk.jpg?alt=media',
    websiteIds: ['chicagoairportblackcar', 'chicagoexecutivecarservice', 'chicagoweddingtransportation', 'chicago-partybus']
  },
  {
    ...
    excerpt: 'Plan your transportation for Chicago\'s biggest events in 2026, from Restaurant Week to Pride Fest.',
    content: `
    ...
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/royalcarriagelimoseo.firebasestorage.app/o/blog%2Fchicago-skyline.jpg?alt=media',
    websiteIds: ['chicagoairportblackcar', 'chicagoexecutivecarservice', 'chicagoweddingtransportation', 'chicago-partybus']
  },
  {
    ...
    excerpt: 'Experience Chicago\'s best nightlife neighborhoods by party bus - the ultimate way to bar hop with your crew.',
    content: `
    ...
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/royalcarriagelimoseo.firebasestorage.app/o/blog%2Fparty-bus-interior.jpg?alt=media',
...
async function updateLocationsWithEvents() {
  ...
  for (const doc of locSnap.docs) {
    ...
    const locationEvents = CHICAGO_EVENTS.filter(e =>
      e.locationSlug === slug ||
