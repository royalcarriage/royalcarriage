...
const fleetVehiclesData = [
  // LUXURY SEDANS (4 vehicles)
  {
    ...
    description:
      "The Lincoln Continental represents the pinnacle of American luxury sedan design. Perfect for executive airport transfers, corporate meetings, and professional business travel throughout Chicago and suburbs.",
    seoKeywords: [
  ...
  },
  {
    ...
    applicableLocations: "all",
    description:
      "The Cadillac XTS combines sophisticated American luxury with cutting-edge technology. Designed for professional business travelers and corporate executives.",
    seoKeywords: [
  ...
  },
  {
    ...
    applicableLocations: "all",
    description:
      "The Mercedes-Benz S-Class sets the global standard for luxury sedans. Engineered for VIP clients and executive travelers who demand the absolute best.",
    seoKeywords: [
  ...
  },
  {
    ...
    applicableLocations: "all",
    description:
      "The BMW 7 Series represents the perfect fusion of performance luxury and executive comfort. Designed for corporate leaders and discerning travelers.",
    seoKeywords: [
  ...
  // LUXURY SUVs (4 vehicles)
  {
    ...
    applicableLocations: "all",
    description:
      "The Cadillac Escalade ESV is the ultimate luxury SUV for group travel. With seating for 6 passengers and abundant cargo space.",
    seoKeywords: [
  ...
  },
  {
    ...
    applicableLocations: "all",
    description:
      "The Lincoln Navigator redefines luxury SUV travel with its spacious cabin and executive-level appointments.",
    seoKeywords: [
  ...
  },
  {
    ...
    applicableLocations: "all",
    description:
      "The Chevrolet Suburban is the trusted choice for reliable group transportation. Perfect for family airport transfers and group events.",
    seoKeywords: [
  ...
  },
  {
    ...
    applicableLocations: "all",
    description:
      "The GMC Yukon Denali delivers premium luxury in a versatile SUV package. Perfect for corporate groups and wedding parties.",
    seoKeywords: [
  ...
  // STRETCH LIMOUSINES (1 vehicle)
  {
    ...
    applicableLocations: "all",
    description:
      "The Lincoln Stretch Limousine is the iconic choice for unforgettable celebrations. Perfect for weddings, proms, and special nights out.",
    seoKeywords: [
  ...
  // EXECUTIVE VANS (2 vehicles)
  {
    ...
    applicableLocations: "all",
    description:
      "The Mercedes Sprinter Van is the premier choice for group airport transfers and corporate shuttles. Seats 14 passengers with generous luggage space.",
    seoKeywords: [
  ...
  },
  {
    ...
    applicableLocations: "all",
    description:
      "The Luxury Executive Sprinter redefines group business travel with premium appointments and executive-level comfort.",
    seoKeywords: [
  ...
  // PARTY BUSES (2 vehicles)
  {
    ...
    applicableLocations: "all",
    description:
      "The Full-Size Party Bus is the ultimate mobile celebration venue for large groups. Perfect for bachelor and bachelorette parties.",
    seoKeywords: [
  ...
  },
  {
    ...
    applicableLocations: "all",
    description:
      "The Mid-Size Party Bus offers the perfect balance of party atmosphere and manageable group size.",
    seoKeywords: [
  ...
  // COACH BUSES (1 vehicle)
  {
    ...
    applicableLocations: "all",
    description:
      "The Full-Size Motor Coach is the ultimate solution for large group transportation. Perfect for corporate tours and conventions.",
    seoKeywords: [
...
async function main() {
  ...
  try {
    ...
    console.log(
      `  ✓ ${fleetResults.created} created, ${fleetResults.updated} updated`,
    );
    console.log(`\nServices:`);
    console.log(
      `  ✓ ${servicesResults.created} created, ${servicesResults.updated} updated`,
    );
