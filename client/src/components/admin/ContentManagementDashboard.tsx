      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Manage pages, drafts, and city content
          </p>
        </div>
              ...
              {filteredPages
                ...
                .map((page) => (
                  <tr key={page.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(page.status)}`}
                      >
                        {page.status}
                      </span>
                    </td>
                    <td className="px-6 py-4">
                      <span
                        className={`font-semibold ${getScoreColor(page.seoScore)}`}
                      >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`font-semibold ${getScoreColor(page.profitScore)}`}
                      >
                        {page.profitScore}
                      </span>
                    </td>
