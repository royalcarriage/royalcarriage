  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
        <h2 className={`text-2xl md:text-3xl lg:text-4xl font-bold mb-4 ${isDark ? "text-background" : "text-foreground"}`}>
          {title}
        </h2>
        <p className={`text-lg max-w-2xl mx-auto mb-8 ${isDark ? "text-background/80" : "text-muted-foreground"}`}>
          {subtitle}
        </p>
