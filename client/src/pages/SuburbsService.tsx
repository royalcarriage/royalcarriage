...
const faqs = [
  {
    ...
    answer:
      "We serve 80+ cities across the Chicago metropolitan area including all western, northwestern, northern, southern, and far western suburbs. If you don't see your city listed, contact us—we likely provide service to your area.",
  },
  {
    question: "How far in advance should I book for suburban pickups?",
    answer:
      "We recommend booking at least 24 hours in advance for standard suburban pickups. For early morning departures (before 6 AM), please book 48 hours ahead to ensure availability.",
  },
  {
    question: "Is there an extra fee for suburban pickups?",
    answer:
      "No hidden fees. Our flat-rate pricing is based on distance from the airport. You'll receive an all-inclusive quote before booking that won't change regardless of traffic or weather.",
  },
  {
    question: "Do you pick up from residential addresses?",
    answer:
      "Yes! We provide true door-to-door service, picking you up directly from your home, office, or any address in the Chicago suburbs.",
  },
  {
    question: "How does pricing compare to airport parking?",
    answer:
      "For trips of 5+ days, our round-trip black car service often costs less than airport parking when you factor in gas, parking fees, and the convenience of door-to-door service.",
  },
  {
    question: "Can you accommodate early morning or late night pickups?",
    answer:
      "Absolutely. We operate 24/7 and regularly handle 4 AM departures and late-night arrivals. Our chauffeurs are accustomed to early and late schedules.",
  },
  {
    question: "What if my flight is delayed or arrives early?",
    answer:
      "We track all flights in real-time and adjust your pickup accordingly. There's no extra charge for flight delays—your driver will be waiting when you arrive.",
  },
  {
    question: "Do you provide service to both O'Hare and Midway?",
    answer:
      "Yes! We provide transportation to both O'Hare (ORD) and Midway (MDW) airports from all Chicago suburbs.",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="max-w-4xl">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              Living in the Chicago suburbs doesn't mean compromising on quality
              airport transportation. Our premium black car service provides
              door-to-door pickup from your home, office, or any location
              throughout the Chicagoland suburbs.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              Whether you're in{" "}
              <Link
                href="/city/naperville"
              ...
              , our professional chauffeurs provide reliable, comfortable
              service that eliminates the stress of airport parking and traffic
              navigation.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                data-testid="button-suburbs-book"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Select your city below for specific service details, distances to
              airports, and booking information.
            </p>
          </div>
          ...
          <p className="text-center text-muted-foreground mt-8">
            Don't see your suburb? We serve the entire Chicagoland area.{" "}
            <Link
              href="/contact"
              className="text-foreground underline hover:text-foreground/80"
            >
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
            <Link
              href="/ohare-airport-limo"
              className="block p-6 bg-accent rounded-lg hover-elevate transition-all"
              data-testid="link-ohare-service"
            >
              ...
              <p className="text-sm text-muted-foreground">
                Black car service to Chicago O'Hare with flight tracking and
            ...
            <Link
              href="/midway-airport-limo"
              className="block p-6 bg-accent rounded-lg hover-elevate transition-all"
              data-testid="link-midway-service"
            >
              <Plane className="w-8 h-8 text-foreground mb-4" />
              <h3 className="font-semibold mb-2 text-foreground">
                Midway Airport (MDW)
              ...
              <p className="text-sm text-muted-foreground">
                Premium transportation to Chicago Midway with professional
                chauffeurs.
              </p>
            </Link>
            <Link
              ...
              className="block p-6 bg-accent rounded-lg hover-elevate transition-all"
              data-testid="link-downtown-service"
            >
              ...
              <p className="text-sm text-muted-foreground">
                Airport transfers to the Loop, River North, Magnificent Mile,
                and beyond.
              </p>
            </Link>
          </div>
          <div className="text-center">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                data-testid="button-suburbs-book-2"
              >
                <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer">
                  <Calendar className="w-5 h-5 mr-2" />
                  Book Online
      ...
      <section className="py-16 md:py-24 bg-accent">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="max-w-4xl">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              For suburban residents, getting to the airport presents unique
              challenges. Long-term airport parking is expensive and requires
              shuttle buses. Rideshare availability varies by location and time
              of day. Public transportation often requires multiple transfers.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              Our black car service solves these problems with reliable
              door-to-door transportation. Your professional chauffeur arrives
              at your home, handles your luggage, and delivers you directly to
              your terminal. On the return, we're waiting when you land—no surge
              pricing, no searching for your ride.
            </p>
            ...
            <div className="bg-background p-6 rounded-lg mb-8">
              <h3 className="font-semibold text-lg mb-4 text-foreground">
                Cost Comparison: Black Car vs. Airport Parking
              </h3>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-center gap-2">
                  ...
                  <span>
                    <strong>Airport parking:</strong> $15-22/day × 7 days =
                    $105-154, plus gas and wear on your vehicle
                  </span>
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-foreground flex-shrink-0" />
                  <span>
                    <strong>Rideshare (each way):</strong> $40-80 depending on
                    surge, plus 15-20 min wait time
                  </span>
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-foreground flex-shrink-0" />
                  <span>
                    <strong>Black car round-trip:</strong> Competitive flat-rate
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                data-testid="button-suburbs-book-3"
              >
                <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer">
                  <Calendar className="w-5 h-5 mr-2" />
                  Book Online
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <Accordion
              ...
              collapsible
              className="w-full"
              data-testid="accordion-suburbs-faq"
            >
              {faqs.map((faq, index) => (
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                data-testid="button-suburbs-book-4"
              >
                <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer">
                  <Calendar className="w-5 h-5 mr-2" />
                  Book Online
