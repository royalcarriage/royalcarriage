...
function generateFAQs(
  ...
  return [
    ...
    },
    {
      ...
      answer:
        "Yes. Quote-based flat rates with taxes and tolls itemized. No surge pricing.",
    },
    {
      question: "Do you track flights?",
      answer:
        "Yes. We monitor all arrivals at O'Hare and Midway and adjust pickup times automatically.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. Meet-and-greet can be arranged at baggage claim with a name sign.",
    },
    {
      question: "What vehicles do you recommend for groups?",
      answer:
        "SUVs accommodate 4-6 passengers with luggage. Sprinter vans are ideal for larger groups.",
    },
    {
      question: "Can I schedule a round-trip?",
      answer:
        "Yes. Book round-trip service for coordinated timing and preferred chauffeur continuity.",
    },
  ];
}
...
export default function CityPage() {
  ...
  const faqs = generateFAQs(
    city.name,
    city.distanceToOhare,
    city.distanceToMidway,
  );
  const relatedCities = getRelatedCities(city.slug, 8);
  const regionCities = getCitiesByRegion(city.region)
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="max-w-4xl">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              Chicago Airport Black Car provides reliable {city.name} airport
              ...
              ({city.distanceToMidway}). Our professional chauffeurs deliver
              door-to-door service with flight tracking and flat-rate pricing.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              We also provide {city.name} to{" "}
              <Link
                href="/airport-limo-downtown-chicago"
                className="text-foreground underline hover:text-foreground/80"
              >
              ...
              transportation for business meetings, events, and dining. Explore
              our full{" "}
              <Link
                href="/airport-limo-suburbs"
                className="text-foreground underline hover:text-foreground/80"
              ...
              covering 80+ Chicago area cities.
            </p>
            ...
            <DualCTAs
              callTestId="button-city-call-1"
              bookTestId="button-city-book-1"
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-accent">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="text-center">
            ...
            <DualCTAs
              callTestId="button-city-call-2"
              bookTestId="button-city-book-2"
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="max-w-4xl">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              {city.name} residents expect reliable, professional transportation
              for airport travel. Unlike rideshare services with unpredictable
              pricing and driver quality, our{" "}
              <Link
                href="/fleet"
                className="text-foreground underline hover:text-foreground/80"
              >
              ...
              delivers consistent service every time. We're licensed, insured,
              and committed to on-time arrivals.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              ...
              for an early morning flight or returning from{" "}
              <Link
                href="/midway-airport-limo"
                className="text-foreground underline hover:text-foreground/80"
              >
              ...
              late at night, our chauffeurs monitor your flight and adjust
              pickup times automatically. We serve all {city.region} communities
              including{" "}
              {regionCities
                .slice(0, 3)
                .map((c) => c.name)
            ...
            <DualCTAs
              callTestId="button-city-call-3"
              bookTestId="button-city-book-3"
            />
          </div>
        </div>
      </section>
            ...
            {regionCities.map((nearbyCity) => (
              ...
              >
                ...
                <p className="text-xs text-muted-foreground">
                  ORD: {nearbyCity.distanceToOhare}
                </p>
                <p className="text-xs text-muted-foreground">
                  MDW: {nearbyCity.distanceToMidway}
                </p>
              </Link>
            ))}
          </div>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="max-w-4xl">
            ...
            <div className="mt-8">
              <DualCTAs
                callTestId="button-city-call-4"
                bookTestId="button-city-book-4"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-foreground text-background">
        <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
          ...
          <p className="text-background/80 text-lg mb-8 max-w-2xl mx-auto">
            Professional chauffeurs, luxury vehicles, and reliable service from{" "}
            {city.name} to O'Hare, Midway, and Downtown Chicago.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              size="lg"
              variant="secondary"
              data-testid="button-city-final-call"
            >
              <a href={PHONE_TEL}>
                <Phone className="w-5 h-5 mr-2" />
                {PHONE_NUMBER}
            ...
            <Button
              ...
              data-testid="button-city-final-book"
            >
              <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer">
                <Calendar className="w-5 h-5 mr-2" />
                Book Online Now
