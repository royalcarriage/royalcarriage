...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Yes. Your chauffeur can meet you inside baggage claim with a name sign.",
  },
  {
    question: "What areas do you cover?",
    answer:
      "Downtown Chicago plus 50+ suburbs, including Naperville, Schaumburg, and Oak Brook.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Often yes, subject to availability. For urgent trips, call dispatch.",
  },
  {
...
const comparisonPoints = [
  {
    ...
    description:
      "Know exactly who's picking you up and when. We track your flight and adjust pickup times automatically.",
  },
  {
    icon: Shield,
    title: "Fixed quote once booked",
    description:
      "No surge pricing, no surprises. Your flat rate is locked in at booking time.",
  },
  {
    icon: Users,
    title: "Meet-and-greet available",
    description:
      "Your chauffeur can meet you inside baggage claim with a name sign for smoother arrivals.",
  },
  {
    icon: Car,
    title: "Multiple vehicle sizes",
    description:
      "Choose from sedans, SUVs, and sprinters based on your group size and luggage needs.",
  },
];
...
function SectionCTA() {
  return (
    <div className="flex flex-col sm:flex-row gap-3 justify-center mt-8">
      <Button asChild size="lg" data-testid="button-section-call">
        <a href={PHONE_TEL}>
...
export default function Home() {
  return (
    <Layout>
      ...
      >
        <div className="max-w-4xl mx-auto px-4 md:px-8">
          ...
          <p className="text-muted-foreground text-lg mb-6 text-center">
            Our professional chauffeurs monitor your flight in real-time,
            ensuring they're there when you land — not when your flight was
            scheduled to arrive.
          </p>
          <ul className="space-y-3 max-w-xl mx-auto mb-6">
            <li className="flex items-start gap-3">
              ...
              <span className="text-muted-foreground">
                Automatic flight tracking for arrivals at O'Hare and Midway
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Check className="w-5 h-5 text-foreground mt-0.5 flex-shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <Check className="w-5 h-5 text-foreground mt-0.5 flex-shrink-0" />
              <span className="text-muted-foreground">
                Complimentary 60-minute wait time for airport pickups
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Check className="w-5 h-5 text-foreground mt-0.5 flex-shrink-0" />
              <span className="text-muted-foreground">
                Meet-and-greet available inside baggage claim
              </span>
            </li>
          </ul>
          <SectionCTA />
      ...
      <section
        className="py-12 md:py-16 bg-accent"
      ...
      >
        <div className="max-w-4xl mx-auto px-4 md:px-8">
          ...
          <p className="text-muted-foreground text-lg mb-6 text-center">
            Whether you're heading to O'Hare, Midway, or flying private, we
            cover all Chicago-area airports with reliable black car service.
          </p>
          <ul className="space-y-3 max-w-xl mx-auto mb-6">
            <li className="flex items-start gap-3">
              <Check className="w-5 h-5 text-foreground mt-0.5 flex-shrink-0" />
              <span className="text-muted-foreground">
                O'Hare International Airport (ORD) — all terminals
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Check className="w-5 h-5 text-foreground mt-0.5 flex-shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <Check className="w-5 h-5 text-foreground mt-0.5 flex-shrink-0" />
              <span className="text-muted-foreground">
                Downtown Chicago hotels and convention centers
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Check className="w-5 h-5 text-foreground mt-0.5 flex-shrink-0" />
              <span className="text-muted-foreground">
                50+ suburbs including Naperville, Schaumburg, and Oak Brook
              </span>
            </li>
          </ul>
          <SectionCTA />
      ...
      >
        <div className="max-w-4xl mx-auto px-4 md:px-8">
          ...
          <p className="text-muted-foreground text-lg mb-8 text-center">
            Reserved black car service offers reliability and comfort that
            rideshare and taxi services simply can't match.
          </p>
