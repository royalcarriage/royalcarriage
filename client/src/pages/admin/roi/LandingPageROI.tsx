  ...
  return pages
    .map((page) => {
      ...
      return {
        ...
        utmSource: ["google", "bing", "facebook", "direct"][
...
export function LandingPageROI() {
  ...
  const [sortField, setSortField] =
    useState<keyof LandingPageROI>("profitProxy");
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b">
                  ...
                  <th
                    className="text-right p-2 cursor-pointer hover:bg-gray-50"
                    onClick={() => handleSort("profitProxy")}
                  >
                    <div className="flex items-center justify-end gap-1">
                  ...
                  <th
                    className="text-right p-2 cursor-pointer hover:bg-gray-50"
                    onClick={() => handleSort("revenuePerSession")}
                  >
                    <div className="flex items-center justify-end gap-1">
              ...
              <div className="space-y-1 text-sm">
                <div>
                  ...
                  <span className="font-semibold">
                    {selectedPage.sessions.toLocaleString()}
                  </span>
                </div>
                <div>
                  Total Conversions:{" "}
                  <span className="font-semibold">
                    {selectedPage.conversions}
                  </span>
                </div>
                <div>
                  Total Revenue:{" "}
                  <span className="font-semibold">
                    ${selectedPage.revenue.toLocaleString()}
                  </span>
                </div>
                <div>
                  Profit Proxy:{" "}
                  <span className="font-semibold text-green-600">
                    ${selectedPage.profitProxy.toLocaleString()}
                  </span>
                </div>
                <div>
                  Revenue per Session:{" "}
                  <span className="font-semibold">
                    ${selectedPage.revenuePerSession.toFixed(2)}
                  </span>
                </div>
              </div>
            </div>
