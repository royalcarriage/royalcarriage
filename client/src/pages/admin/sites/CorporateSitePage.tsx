...
export default function CorporateSitePage() {
  return (
    <>
      <SEO
        title="Corporate Site | Royal Carriage Admin"
        description="Corporate transportation site configuration"
        noindex={true}
      />
      <AdminLayout
        title="Corporate Site"
        subtitle="Corporate transportation and business travel service"
        breadcrumbs={[
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium">corporate.royalcarriagelimo.com</span>
              </div>
              <div className="flex items-center justify-between">
