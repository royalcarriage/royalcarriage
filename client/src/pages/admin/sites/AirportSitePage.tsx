...
export default function AirportSitePage() {
  return (
    <>
      <SEO
        title="Airport Site | Royal Carriage Admin"
        description="Airport limousine service site configuration"
        noindex={true}
      />
      <AdminLayout
        title="Airport Site"
        subtitle="O'Hare and Midway airport limousine service"
        breadcrumbs={[
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium">airport.royalcarriagelimo.com</span>
              </div>
              <div className="flex items-center justify-between">
