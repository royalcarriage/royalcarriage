 ...
 * Client-side copy of shared constants
 */
...
export const REVENUE_THRESHOLDS = {
  revenueWoW: { green: 0, yellow: -5, red: -10 },
  adSpendVsRevenue: {
    green: 'revenue > spend',
  ...
  avgOrderValue: { green: 0, yellow: -5, red: -10 }
};

// C. Conversion Health Thresholds
export const CONVERSION_THRESHOLDS = {
  clickToCall: { green: 0, yellow: -5, red: -10 },
  bookNowClicks: { green: 0, yellow: -5, red: -10 },
  scroll75Pct: { green: 40, yellow: 25, red: 0 },
  bounceRate: { green: 0, yellow: 5, red: 10 }
};
...
export const SEO_THRESHOLDS = {
  ...
  coverageErrors: { green: 2, yellow: 10 },
  cannibalization: {
    none: '🟢',
    suspected: '🟡',
    confirmed: '🔴'
