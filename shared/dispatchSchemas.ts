export const dispatchSchemas = {
  trips: {
    ...
    tripStatus: { type: 'string', required: true, enum: ['scheduled', 'assigned', 'en_route_pickup', 'arrived_pickup', 'en_route_dropoff', 'completed', 'cancelled', 'no_show'] },
  ...
  assignments: {
    ...
    status: { type: 'string', required: true, enum: ['pending', 'accepted', 'declined', 'en_route', 'completed', 'cancelled'] },
  ...
  tripStatusHistory: {
    ...
    status: { type: 'string', required: true, enum: ['scheduled', 'assigned', 'en_route_pickup', 'arrived_pickup', 'en_route_dropoff', 'completed', 'cancelled', 'no_show'] },
