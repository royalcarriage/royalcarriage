export const payrollSchemas = {
  driverProfiles: {
    ...
    payRateType: { type: 'string', required: true, enum: ['hourly', 'salary', 'commission'] },
    paymentMethod: { type: 'string', enum: ['direct_deposit', 'check', 'cash'] },
    bankInfo: { type: 'object', properties: {
      accountNumber: { type: 'string' },
      routingNumber: { type: 'string' },
      bankName: { type: 'string' }
    }, optional: true },
    deductions: { type: 'array', items: { type: 'object', properties: {
      name: { type: 'string' },
      amount: { type: 'number' },
  ...
  payRules: {
    ...
    rateMultipliers: { type: 'object', properties: {
  ...
  payrollStatements: {
    ...
    deductions: { type: 'object', properties: {
