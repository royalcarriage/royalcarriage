...
const mockAlerts: FeedbackAlert[] = [
  {
    ...
    sentiment: "negative",
    feedback:
      "The driver was 15 minutes late for our airport pickup. Very stressful experience as we almost missed our flight.",
    source: "google",
  ...
  },
  {
    ...
    sentiment: "negative",
    feedback:
      "Vehicle was not clean and the AC was not working properly. Expected much better for a luxury service.",
    source: "yelp",
  ...
  },
  {
    ...
    sentiment: "neutral",
    feedback:
      "Service was okay, but communication could be improved. Received confirmation but no driver updates.",
    source: "survey",
    status: "new",
    priority: "medium",
  ...
  },
  {
    ...
    sentiment: "positive",
    feedback:
      "Absolutely wonderful service! Marcus was professional, punctual, and made our wedding day transportation perfect.",
    source: "google",
    ...
    response:
      "Thank you so much for the kind words, Emily! We are thrilled we could be part of your special day.",
  ...
  },
  {
    ...
    sentiment: "negative",
    feedback:
      "Charged more than the quoted price without explanation. Need clarity on pricing.",
    source: "direct",
...
function AlertCard({
  ...
  return (
    <div
      className={`bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border ${
...
export function FeedbackAlerts() {
  ...
  const [filter, setFilter] = useState<
    "all" | "new" | "in_progress" | "escalated" | "resolved"
  >("all");
    ...
    try {
      ...
      if (app) {
        ...
        if (alert) {
          ...
          setAlerts((prev) =>
            prev.map((a) =>
              a.id === id ? { ...a, aiSuggestion: result.data.result } : a,
            ),
          );
...
The Royal Carriage Team`;
  ...
  const handleEscalate = async (id: string) => {
    setAlerts((prev) =>
      prev.map((a) =>
        a.id === id ? { ...a, status: "escalated", assignedTo: "Manager" } : a,
      ),
    );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">
            Monitor and respond to customer feedback with AI assistance
          </p>
        </div>
        <button
      ...
      <div className="flex flex-wrap items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <div className="flex gap-1">
            {(
              ["all", "new", "in_progress", "escalated", "resolved"] as const
            ).map((status) => (
              <button
                key={status}
