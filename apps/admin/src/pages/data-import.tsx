  ...
  const loadDashboardData = async () => {
    try {
      ...
      bookings.forEach((booking) => {
        ...
        tripTypes[tripType] =
          (tripTypes[tripType] || 0) + (booking.totalAmount || 0);
      ...
      const analytics: AnalyticsData = {
        ...
        googleAds: {
          ...
          percentage:
            totalRevenue > 0 ? (googleAdsRevenue / totalRevenue) * 100 : 0,
        },
        metrics: {
          averageTripValue:
            bookings.length > 0 ? totalRevenue / bookings.length : 0,
          driverCostPercentage:
            totalRevenue > 0 ? (totalDriverPayout / totalRevenue) * 100 : 0,
        },
      };
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-slate-400">
          Manage CSV imports and view real-time analytics
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg p-6 border border-slate-700">
          ...
          <p className="text-slate-500 text-xs">
            Last updated:{" "}
            {importStats?.timestamp
              ? new Date(importStats.timestamp).toLocaleDateString()
              : "Never"}
          </p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-amber-400 font-bold">
                    $
                    {analyticsData.revenue.bySource.google_ads.toLocaleString(
                      "en-US",
                      { maximumFractionDigits: 2 },
                    )}
                  </span>
              ...
              <div>
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-blue-400 font-bold">
                    $
                    {analyticsData.revenue.bySource.direct.toLocaleString(
                      "en-US",
                      { maximumFractionDigits: 2 },
                    )}
                  </span>
              ...
              <div className="pt-4 border-t border-slate-700">
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-bold">
                    $
                    {analyticsData.metrics.averageTripValue.toLocaleString(
                      "en-US",
                      { maximumFractionDigits: 2 },
                    )}
                  </span>
          ...
          {analyticsData && (
            <div className="space-y-6">
                ...
                <div className="flex items-end justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-amber-400">
                      {analyticsData.googleAds.bookings}
                    </p>
                  </div>
                  <div className="text-right">
                    <p className="text-amber-400 text-lg font-bold">
                      {analyticsData.googleAds.percentage.toFixed(1)}%
                    </p>
              ...
              <div className="bg-slate-700/50 rounded-lg p-4">
                ...
                <p className="text-3xl font-bold text-white mt-2">
                  $
                  {analyticsData.googleAds.revenue.toLocaleString("en-US", {
                    maximumFractionDigits: 2,
                  })}
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-slate-700/50 rounded-lg p-3">
                  ...
                  <p className="text-lg font-bold text-blue-400">
                    {importStats &&
                      importStats.imported - analyticsData.googleAds.bookings}
                  </p>
                </div>
                <div className="bg-slate-700/50 rounded-lg p-3">
                  <p className="text-slate-400 text-xs">Total Trips</p>
                  <p className="text-lg font-bold text-white">
                    {analyticsData.trips.total}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-slate-700/50 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-red-400 mt-2">
                {analyticsData.metrics.driverCostPercentage.toFixed(1)}%
              </p>
              <p className="text-slate-500 text-xs mt-2">
                of revenue paid to drivers
              </p>
            </div>
            ...
            <div className="bg-slate-700/50 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-green-400 mt-2">
                {(100 - analyticsData.metrics.driverCostPercentage).toFixed(1)}%
              </p>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="font-bold text-white mb-2">
              Ready to Import More Data?
            </h3>
            <p className="text-slate-400 mb-4">
              Upload a new CSV file to add more reservation data and update
              analytics instantly.
            </p>
