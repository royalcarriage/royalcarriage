...
export default function CompetitorAnalysisPage() {
  ...
  const [analysisDepth, setAnalysisDepth] = useState<"quick" | "detailed">(
    "detailed",
  );
  ...
  async function loadActionItems() {
    try {
      const q = query(
        collection(db, "competitor_action_items"),
  ...
  async function handleRunAnalysis() {
    ...
    try {
      ...
      alert(
        `Failed to run analysis: ${error.message || "Check console for details."}`,
      );
    } finally {
      setAnalyzing(false);
    }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Analyze competitor websites to identify keyword opportunities,
            service gaps, and content strategy insights
          </p>
        </div>
        ...
        <div className="mb-8 flex flex-wrap justify-between items-center gap-4 bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-200">
          <div className="flex items-center gap-4">
            <select
              value={analysisDepth}
              onChange={(e) =>
                setAnalysisDepth(e.target.value as "quick" | "detailed")
              }
        ...
        {loading ? (
            ...
            <div className="flex gap-1 mb-8 border-b overflow-x-auto">
              {(
                [
                  ...
                  {
                    id: "actions",
                    label: `Action Items (${actionItems.filter((a) => a.status !== "completed").length})`,
                  },
                ] as const
              ).map((tab) => (
                <button
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 mb-8">
                  ...
                  <div className="bg-gradient-to-br from-red-50 to-red-100 border border-red-200 p-6 rounded-lg">
                    <div className="text-3xl font-bold text-red-600">
                      {(analysis.gaps?.serviceGaps?.length || 0) +
                        (analysis.gaps?.locationGaps?.length || 0)}
                    </div>
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            ...
                            <span className="font-semibold">
                              {(
                                competitor.metrics?.estimatedTraffic || 0
                              ).toLocaleString()}
                              /mo
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span className="font-semibold">
                              {(
                                competitor.metrics?.backlinks || 0
                              ).toLocaleString()}
                            </span>
                          </div>
                          <div className="flex justify-between">
                          ...
                          <div className="pt-2 border-t mt-2">
                            <div className="text-gray-600 mb-1">
                              Services ({competitor.services?.length || 0}):
                            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 border rounded-lg p-4 flex flex-wrap gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFilterDifficulty(parseInt(e.target.value))
                      }
                      className="w-48"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={filterVolume}
                      onChange={(e) =>
                        setFilterVolume(parseInt(e.target.value))
                      }
                      className="w-48"
                    />
                  </div>
                  <div className="flex items-end">
                    <span className="text-sm text-gray-600">
                      ...
                      {
                        analysis.opportunities.topOpportunities.filter(
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-600">
                    Keywords competitors rank for that we don't - sorted by
                      ...
                      >
                        <div className="flex justify-between items-start mb-3">
                          <div>
                            ...
                            <p className="text-xs text-gray-500">
                              Opportunity Score:{" "}
                              {opportunity.opportunity.toFixed(0)}
                            </p>
                          </div>
                        ...
                        <div className="grid grid-cols-4 gap-3">
                          <div className="bg-blue-50 p-3 rounded">
                            ...
                            <div
                              className={`font-bold ${getDifficultyColor(opportunity.difficulty)}`}
                            >
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Services that competitors offer but we don't have content
                    for
                  </p>
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
                      <div className="text-3xl font-bold text-red-600">
                        {analysis.gaps?.serviceGaps?.filter(
                          (g) => g.priority === "high",
                        ).length || 0}
                      </div>
                      <div className="text-sm text-gray-600">
                  ...
                  <div className="bg-white border rounded-lg p-6 mb-6">
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        const gap = analysis.gaps?.serviceGaps?.find(
                          (g) => g.serviceType === service,
                        );
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Locations that competitors target but we don't have content
                    for
                  </p>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Easy-to-rank keywords (difficulty &lt; 50) that competitors
                    rank for
                  </p>
                        ...
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <div className="text-xs text-gray-500 mt-1">
                              Volume: {kw.searchVolume} | Difficulty:{" "}
                              {kw.difficulty}
                            </div>
                          </div>
                          <button
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="border rounded-lg p-6">
                    <h3 className="font-bold text-lg mb-2 text-red-600">
                      They Rank For (We Don't)
                    </h3>
                    <p className="text-sm text-gray-600 mb-4">
                      {analysis.comparison.theyRankForButWeDont.length} keywords
                      - opportunity to create content
                    </p>
                    <div className="space-y-1 max-h-96 overflow-y-auto">
                      {analysis.comparison.theyRankForButWeDont
                        .slice(0, 25)
                        .map((keyword, idx) => (
                          <div
                            key={idx}
                  ...
                  <div className="border rounded-lg p-6">
                    <h3 className="font-bold text-lg mb-2 text-green-600">
                      We Rank For (They Don't)
                    </h3>
                    <p className="text-sm text-gray-600 mb-4">
                      {analysis.comparison.weRankForButTheyDont.length} keywords
                      - our competitive advantage
                    </p>
                    <div className="space-y-1 max-h-96 overflow-y-auto">
                      {analysis.comparison.weRankForButTheyDont
                        .slice(0, 25)
                        .map((keyword, idx) => (
                          <div
                            key={idx}
                          ...
                          >
                            <div className="flex justify-between items-start mb-2">
                              <div className="flex-1">
                                ...
                                {item.searchVolume && (
                                  <div className="text-xs text-gray-500 mt-1">
                                    Volume: {item.searchVolume} | Difficulty:{" "}
                                    {item.difficulty}
                                  </div>
                                )}
                              </div>
                ...
                {actionItems.length === 0 && (
                  <div className="text-center py-12 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-sm text-gray-500">
                      Browse the Opportunities or Gaps tabs to create action
                      items for content creation.
                    </p>
                  </div>
                )}
              </div>
          ...
          <div className="text-center py-12 bg-gray-50 rounded-lg">
            ...
            <p className="text-gray-600 mb-6">
              Run your first analysis to discover keyword opportunities and
              service gaps.
            </p>
            <button
              onClick={handleRunAnalysis}
