...
const OUTPUT_INDEX = path.join(__dirname, "..", "lib", "functions", "src", "index.js");
const OUTPUT_MAP = path.join(__dirname, "..", "lib", "functions", "src", "index.js.map");
...
if (!fs.existsSync(OUTPUT_INDEX)) {
  console.warn("postbuild: functions/lib/functions/src/index.js not found; skipping copy.");
  process.exit(0);
}
