...
Respond with valid JSON:
{
  ...
  "urgency": "high|medium|low"
      ...
      functions.logger.info(
        "[generateResponseSuggestion] Generating suggestions",
        {
          feedbackId,
        },
      );
        ...
        suggestions: [
          {
            type: "brief",
            response:
              "We apologize for your experience and would like to make it right. Please contact us at your convenience.",
            tone: "apologetic",
          },
        ],
      ...
      functions.logger.info(
        "[generateResponseSuggestion] Suggestions generated",
        {
          feedbackId,
