/**
 * Data Initialization Routes - Phase 4
 * Endpoints for initializing production data
 */
...
const SERVICES_DATA: Service[] = [
  // Airport Services (24)
  {
    ...
    category: 'Airport',
    description: 'Professional ground transportation to and from Chicago O\'Hare International Airport',
    basePrice: 95,
    keywords: ['oHare', 'airport transfer', 'ground transportation', 'chicago airport'],
    searchVolume: 8500,
    difficulty: 1,
  },
  {
    ...
    category: 'Airport',
    description: 'Reliable transportation service to and from Chicago Midway International Airport',
    basePrice: 65,
  ...
  },
  {
    ...
    category: 'Airport',
    description: 'Premium luxury ground transportation for business travelers and executives',
    basePrice: 150,
    keywords: ['executive airport', 'business travel', 'luxury ground transportation'],
    searchVolume: 3400,
    difficulty: 2,
  },
  {
    ...
    category: 'Airport',
    description: 'Economical group transportation for multiple passengers traveling together',
    basePrice: 45,
  ...
  },
  {
    ...
    category: 'Airport',
    description: 'Professional meet and greet service with driver assistance at airport terminals',
    basePrice: 35,
  ...
  },
  {
    ...
    category: 'Corporate',
    description: 'Professional ground transportation for business meetings and client visits',
    basePrice: 120,
  ...
  },
  {
    ...
    category: 'Corporate',
    description: 'Luxury transportation for client entertainment and business networking events',
    basePrice: 180,
    keywords: ['client entertainment', 'business networking', 'corporate event'],
    searchVolume: 2800,
    difficulty: 2,
  },
  {
    ...
    category: 'Corporate',
    description: 'Comprehensive transportation management for corporate conferences and conventions',
    basePrice: 150,
  ...
  },
  {
    ...
    category: 'Corporate',
    description: 'Daily shuttle service for corporate offices and business parks',
    basePrice: 85,
  ...
  // Wedding Services (30)
  {
    ...
    category: 'Wedding',
    description: 'Elegant transportation for the bride and groom on their wedding day',
    basePrice: 250,
  ...
  },
  {
    ...
    category: 'Wedding',
    description: 'Group transportation for wedding guests between venues and hotel accommodations',
    basePrice: 95,
  ...
  },
  {
    ...
    category: 'Wedding',
    description: 'Coordinated transportation management for weddings spanning multiple venues',
    basePrice: 300,
  ...
  },
  {
    ...
    category: 'Wedding',
    description: 'Continuous shuttle service between reception and hotel accommodations',
    basePrice: 110,
  ...
  },
  {
    ...
    category: 'Wedding',
    description: 'Premium all-inclusive transportation package with concierge services',
    basePrice: 400,
    keywords: ['vip wedding', 'premium wedding', 'luxury wedding transportation'],
    searchVolume: 1900,
    difficulty: 3,
  },
  // Party Bus Services (13)
  {
    ...
    category: 'Party',
    description: 'Fun and entertainment-focused ground transportation for bachelor parties',
    basePrice: 200,
  ...
  },
  {
    ...
    category: 'Party',
    description: 'Group transportation service for nightclub and bar hopping adventures',
    basePrice: 180,
  ...
  },
  {
    ...
    category: 'Party',
    description: 'Mobile party space with entertainment for birthday celebrations',
    basePrice: 175,
  ...
  },
  {
    ...
    category: 'Party',
    description: 'Transportation service for concerts, sporting events, and live entertainment',
    basePrice: 160,
  ...
  },
  {
    ...
    category: 'Party',
    description: 'All-inclusive transportation for casino trips and gambling excursions',
    basePrice: 220,
...
/**
 * POST /api/init/production-data
 * Initialize production data in Firestore
 */
router.post('/production-data', async (req: Request, res: Response) => {
  try {
    functions.logger.info('Starting Phase 4: Production Data Initialization');

    const locationsCount = await insertLocations();
    functions.logger.info(`Inserted ${locationsCount} locations`);

    const servicesCount = await insertServices();
    functions.logger.info(`Inserted ${servicesCount} services`);

    const mappingsCount = await createLocationServiceMappings();
    functions.logger.info(`Created ${mappingsCount} location-service mappings`);

    const queueCount = await createInitialContentQueue();
    functions.logger.info(`Queued ${queueCount} content generation tasks`);
    ...
    functions.logger.error('Error during initialization:', error);
    res.status(500).json({
      success: false,
