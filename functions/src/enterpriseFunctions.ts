...
export const calculateProfitProxy = functions.https.onCall(
  async (data, context) => {
...
export const seoProposeDrafts = functions.pubsub
...
export const runFullEnterpriseAudit = functions.https.onCall(
  async (data, context) => {
