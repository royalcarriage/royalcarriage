...
export const convertLeadToCustomer = functions.https.onCall(
  async (data, context) => {
    verifyAuth(context);
    ...
    await db
      .collection("leads")
      .doc(data.leadId)
      .update({ status: "converted", customerId: custRef.id });
...
export const getCustomerHistory = functions.https.onCall(
  async (data, context) => {
    verifyAuth(context);
...
export const blacklistCustomer = functions.https.onCall(
  async (data, context) => {
    verifyAuth(context);
...
export const sendCustomerEmail = functions.https.onCall(
  async (data, context) => {
    verifyAuth(context);
...
export const getCustomerStats = functions.https.onCall(
  async (data, context) => {
    verifyAuth(context);
    const trips = await db
      .collection("trips")
