...
const BASE_BOOKING_URL = "https://customer.moovs.app/royal-carriage-limousine/new/info";

export const SITE_CONFIGS: Record<string, SiteConfig> = {
  airport: {
    target: "airport",
    name: "Chicago Airport Black Car Service - Royal Carriage Limousine",
    description: "Premium airport limousine service in Chicago. Professional transportation to O'Hare and Midway airports, downtown Chicago, and suburbs. Reliable, luxury black car service available 24/7.",
    phone: GLOBAL_PHONE,
    phoneDisplay: GLOBAL_PHONE_DISPLAY,
    bookingUrl: `${BASE_BOOKING_URL}?utm_source=airport&utm_medium=seo&utm_campaign=microsites`,
    domain: "https://chicagoairportblackcar.web.app",
    socialMedia: {
  ...
  corporate: {
    ...
    description: "Professional corporate black car service in Chicago. Executive transportation, hourly chauffeur services, and business travel solutions. Reliable, discreet, and punctual service for professionals.",
    phone: GLOBAL_PHONE,
    phoneDisplay: GLOBAL_PHONE_DISPLAY,
    bookingUrl: `${BASE_BOOKING_URL}?utm_source=corporate&utm_medium=seo&utm_campaign=microsites`,
    domain: "https://chicagoexecutivecarservice.web.app",
    socialMedia: {
      facebook: "https://www.facebook.com/RoyalCarriageLimo",
      instagram: "https://www.instagram.com/royalcarriagelimo",
  ...
  wedding: {
    ...
    description: "Elegant wedding limousine service in Chicago. Professional transportation for weddings, bridal parties, and special occasions. Make your special day memorable with luxury vehicles and experienced chauffeurs.",
    phone: GLOBAL_PHONE,
    phoneDisplay: GLOBAL_PHONE_DISPLAY,
    bookingUrl: `${BASE_BOOKING_URL}?utm_source=wedding&utm_medium=seo&utm_campaign=microsites`,
    domain: "https://chicagoweddingtransportation.web.app",
    socialMedia: {
      facebook: "https://www.facebook.com/RoyalCarriageLimo",
      instagram: "https://www.instagram.com/royalcarriagelimo"
    },
  ...
  partybus: {
    ...
    description: "Premium party bus rentals in Chicago. Perfect for birthdays, concerts, bachelor/bachelorette parties, and special events. Spacious, entertaining, and safe group transportation.",
    phone: GLOBAL_PHONE,
    phoneDisplay: GLOBAL_PHONE_DISPLAY,
    bookingUrl: `${BASE_BOOKING_URL}?utm_source=partybus&utm_medium=seo&utm_campaign=microsites`,
    domain: "https://chicago-partybus.web.app",
    socialMedia: {
      facebook: "https://www.facebook.com/RoyalCarriageLimo",
      instagram: "https://www.instagram.com/royalcarriagelimo"
    },
